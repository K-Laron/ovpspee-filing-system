...
export const AddDocument = () => {
  ...
  const attachmentList = useMemo(
    () => attachmentPaths.map((path) => path.trim()).filter(Boolean),
    [attachmentPaths],
  );
      ...
      <form className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]" onSubmit={submit}>
        ...
        <div className="rounded border border-border bg-surface p-5 shadow-sm">
          ...
          <p className="mt-2 text-xs text-muted">
            Allowed: PDF, DOC/DOCX, XLS/XLSX, JPG, PNG, TIFF, TXT. Max 1 GB each; backend rejects
              ...
              attachmentList.map((sourcePath) => (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => removeSelectedAttachment(sourcePath)}
